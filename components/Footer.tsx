      ...
      <div className="w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2rem] border-b-[1.4rem] pb-5 border-gray-600 border-opacity-40">
        ...
        <div className="md:mx-auto">
          ...
          {["home", "about", "skills", "projects", "contact"].map((link) => (
            <p
              key={link}
              className="text-[15px] text-white opacity-80 mb-[1rem] cursor-pointer hover:text-cyan-300"
            >
        ...
        <div className="lg:mx-auto">
          <div className="flex items-center mt-[1rem] space-x-2">
            <EnvelopeIcon className="w-[30px] h-[30px] text-cyan-300" />
            <p className="text-[17px] font-normal text-white opacity-75">
              ab.rahmanedu@gmail.com
            </p>
          </div>
          <div className="flex items-center mt-[1rem] space-x-2">
            <PhoneIcon className="w-[30px] h-[30px] text-cyan-300" />
            <p className="text-[17px] font-normal text-white opacity-75">
              +92 3122050069
            </p>
          </div>
          ...
          <div className="flex items-center space-x-4 mt-[1.5rem]">
            <a href="https://github.com/gitarkhubreh" target="_blank" rel="noopener noreferrer">
              <FaGithub className="text-white hover:text-cyan-300 w-[24px] h-[24px]" />
            </a>
           
            <a href="https://wa.me/923122050069?text=welcome%20to%20AK.Rehman%20Webdeveloper" target="_blank" rel="noopener noreferrer">
              <FaWhatsapp className="text-white hover:text-cyan-300 w-[24px] h-[24px]" />
            </a>
            <a href="https://www.facebook.com/profile.php?id=61571467536471" target="_blank" rel="noopener noreferrer">
              <FaFacebookF className="text-white hover:text-cyan-300 w-[24px] h-[24px]" />
            </a>
          </div>
        </div>
      </div>

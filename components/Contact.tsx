      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center w-[80%] mx-auto">
        <div>
          ...
          <h1 className="mt-[0.6rem] p-2 sm:p-0 leading-[3.5rem] text-white text-[27px] md:text-[30px] lg:text-[38px] xl:text-[45px]">
            Let&apos;s <span className="text-cyan-400">Make</span> Your{" "}
            <span className="text-cyan-400">Brand</span> Brilliant
          </h1>
          <p className="text-[15px] text-white mt-[1rem] opacity-75">
            I&apos;m a graphic designer, frontend web developer, and video
            editor with a passion for creating stunning visuals and seamless web
            experiences. Explore my work to see how I blend creativity and
            functionality. Let&apos;s connect and bring your project to life!
          </p>
